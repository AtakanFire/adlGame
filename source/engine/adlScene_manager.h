...
public:
	...
	void addToScene(adlActor* actor);
	...
	void spawnActor(adlActor* actor, adlVec3 position, adlVec3 rotation = adlVec3(0.0f), adlVec3 scale = adlVec3(1.0f));

	adlEntity* spawnActor(const std::string& entity_name, adlVec3 position, adlVec3 rotation, adlVec3 scale);
